...
public class SchedMedExamControllerStepsCreate extends CucumberConfig {
    ...
    public void created_scheduled_medical_exam_is_returned() throws Exception {
        ScheduledMedExamination createdScheduledMedExamination= scheduledMedExamRepository
                .findByLbzDoctor(UUID.fromString("266a1e0c-cf45-11ed-afa1-0242ac120002")).get();
        assertNotNull(createdScheduledMedExamination);
        resultAction.andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(createdScheduledMedExamination.getId()));
    }
